...
class TransformerTrainer:
    """ 
    The class handles the training flow of the Transformer
    """
    ...
    def perform_training(self):
        ...
        train_dataloader, val_dataloader, tokenizer_src, tokenizer_tgt = create_tokenizers_dataloaders(
            self.__config)
        ...
        initial_epoch, global_step = self.__get_initial_model_setup(
        ...
        for epoch in range(initial_epoch, self.__config.MODEL['num_epochs']):
            ...
            for batch in batch_iterator:
                ...
                proj_output = transformer_model.project(
                    decoder_output)  # (B, seq_len, vocab_size)
